...
class Form extends \Illuminate\Support\Facades\Form {
     ...
     * @return string
     */
    static public function open_horizontal($params=false)
    {
     ...
     * @return string
     */
    static public function input_basic($type, $name, $title = null, $value = null, $errors = null, $attributes = array(), $help = null, $label=true,$iconpre=false,$iconpost=false, $buttonpost=false)
    {
		...
		if($label) $txt .= '<label for="'.$name.'" class="col-md-2 control-label">'.$title.'</label>';
     ...
     * @return string
     */
    static public function select_basic($name, $title, $list, $value = null, $errors = null, $attributes = array(), $help = null, $label=true)
    {
        $txt = '<div class="form-group';
        if (!is_null($errors) && $errors->has($name))
            $txt .= ' has-error';
     ...
     * @return string
     */
    static public function input_multi_language_group($languages, $type, $name, $title, $value = null, $errors = null, $attributes = array(), $help = null, $label=true)
    {
        $txt = '<div class="form-group';
        if (!is_null($errors) && $errors->has($name))
            $txt .= ' has-error';
     ...
     * @return string
     */
    static public function textarea_group($name, $title, $value = null, $errors = null, $attributes = array(), $help = null, $label=true)
    {
        $txt = '<div class="form-group';
        if (!is_null($errors) && $errors->has($name))
            $txt .= ' has-error';
     ...
     * @return string
     */
    static public function textarea_multi_language_group($languages, $name, $title, $value = null, $errors = null, $attributes = array(), $help = null, $label=true)
    {
        $txt = '<div class="form-group';
        if (!is_null($errors) && $errors->has($name))
            $txt .= ' has-error';
     ...
     * @return string
     */
    static public function select_group($name, $title, $list, $value = null, $errors = null, $attributes = array(), $help = null, $label=true)
    {
        $txt = '<div class="form-group';
        if (!is_null($errors) && $errors->has($name))
            $txt .= ' has-error';
     ...
     * @return string
     */
    static public function radio_group($name, $title, $choices, $value = 1, $errors = null, $attributes = array(), $help = null, $label=true)
    {
     ...
     * @return string
     */
    static public function text_group($title, $text, $label=true)
    {
        $txt = '<div class="form-group">';
		if($label){
			$txt .= '<div class="col-md-offset-2 col-md-10">';
