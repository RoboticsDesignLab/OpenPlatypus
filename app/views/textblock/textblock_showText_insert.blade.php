...
@else
	...
	<p>
		<button class="btn btn-default btn-copy ajaxCopyLoader" data-copy-target="{{$text_element_id}}" data-url="{{{ route('getTextBlockTextAjax', array("textblock_id" => $textBlock->id, 'role' => $role) ) }}}"><span class="glyphicon glyphicon-copy"></span> Copy Source</button>
	</p>
