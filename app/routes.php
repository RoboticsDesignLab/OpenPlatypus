...
Route::group(array('before' => 'modernbrowser|databaseok'), function() {
	...
	Route::group(array('before' => 'auth'), function() {
		...
		// TextBlockController
		Route::get('textblock/ajax/{textblock_id}/{role}/getText', array('as' => 'getTextBlockTextAjax', 'before' => 'numeric:textblock_id|numeric:role', 'uses' => 'TextBlockController@getTextAjax' ) );
